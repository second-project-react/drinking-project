...
function ModalDisplay(props) {
  ...
  const saveToDatabase = (item) => {
    Axios({
      method: "post",
      url: "https://thecocktailbar.herokuapp.com/api/favorites",
  ...
  const checkIfCocktailInDb = (id, useId) => {
    console.log(id)
    Axios.get(`https://thecocktailbar.herokuapp.com/api/favorites/cocktail/${id}/${useId}`)
    .then((response) => response.data)
   .then((data)=>{
     console.log(data)
     if (data[0].idDrink) {
  ...
  const deleteCocktailfromDb = (id, useId) => {
    console.log(id)
    Axios.get(`https://thecocktailbar.herokuapp.com/api/favorites/delete/${id}/${useId}`)
    .then((response) => response.data)
   .then((data)=>{
     console.log(data)
     if (data === "deleted") {
