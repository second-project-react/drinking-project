...
const Scotch = () => {
    ...
    useEffect(()=> {
        axios
        .get(`https://www.thecocktaildb.com/api/json/v2/${process.env.REACT_APP_API_KEY}/filter.php?i=Scotch`) 
        .then((data) => {
    ...
    return (
        <div className='mainDiv'>
            <h2 className='drinkType'>Scotch</h2>
            {/* <hr size="8" width="40%" color="gray"></hr>  */}
            <h5 className='qoute'>"Where is my Scotch and Soda?"</h5>
