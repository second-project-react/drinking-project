...
const Gin = () => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://www.thecocktaildb.com/api/json/v2/${process.env.REACT_APP_API_KEY}/filter.php?i=Gin`
         )
         .then((data) => {
   ...
   return (
      <div className="mainDiv">
         ...
         <h5 className="qoute">
            "Life may not be the party that we hoped for, but while we are here
            we should drink and dance!"
         </h5>
