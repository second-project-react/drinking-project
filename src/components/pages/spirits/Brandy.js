...
const Brandy = () => {
    ...
    useEffect(()=> {
        axios
        .get(`https://www.thecocktaildb.com/api/json/v2/${process.env.REACT_APP_API_KEY}/filter.php?i=Brandy`) 
        .then((data) => {
    ...
    return (
        <div className='mainDiv'>
            ...
            <h5 className='qoute'>"A party without a drink is afterall just a meeting!"</h5>
