...
const Bourbon = () => {
    ...
    useEffect(()=> {
        axios
        .get(`https://www.thecocktaildb.com/api/json/v2/${process.env.REACT_APP_API_KEY}/filter.php?i=Bourbon`) 
        .then((data) => {
    ...
    return (
        <div className='mainDiv'>
            <h2 className='drinkType'>Bourbon</h2>
            {/* <hr size="8" width="40%" color="gray"></hr>  */}
            <h5 className='qoute'>"Party Sleep Repeat!!"</h5>
