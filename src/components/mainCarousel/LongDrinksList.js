...
export default function LongDrinksList() {
    
    const [drinks, setDrinks] = useState([])
    
    useEffect(()=> {
        axios
        .get(`https://www.thecocktaildb.com/api/json/v2/${process.env.REACT_APP_API_KEY}/filter.php?g=Highball%20glass`) 
        .then((data) => {
    ...
    return (
        <div className='mainDiv'>
            <h2 className='drinkType'>Long Drinks</h2>
